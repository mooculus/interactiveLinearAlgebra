...
\begin{problem}\label{prob:componentform1}
  ...
  Express each vector in component form. 
  \begin{enumerate}
\item
Vector $\vec{v}$ has a tail at $(-2,4)$ and a head at $(4,5)$. 
$$\vec{v}=\begin{bmatrix}\answer{6}\\ \answer{1}\end{bmatrix}$$
% \item
% Vector $\vec{w}$ has a tail at $(8,-5)$ and a head at $(6,7)$.
% $$\vec{w}=\begin{bmatrix}\answer{-2}\\ \answer{12}\end{bmatrix}$$
\item
Vector $\vec{p}$ has a tail at $(2,4,5)$ and a head at $(-2,4,8)$. 
$$\vec{p}=\begin{bmatrix}\answer{-4}\\\answer{0}\\\answer{3}\end{bmatrix}$$
% \item 
%  Vector $\vec{q}$ has a tail at $(-3,4,5)$ and a head at $(7,7,8)$.
% $$\vec{q}=\begin{bmatrix}\answer{10}\\\answer{3}\\\answer{3}\end{bmatrix}$$
 \end{enumerate}
\end{problem}
