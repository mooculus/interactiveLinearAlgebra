...
Recall that by Observation \ref{obs:imagesOfijk} of \href{https://ximera.osu.edu/linearalgebradzv3/LinearAlgebraInteractiveIntro/LTR-0005/main}{Matrix Transformations}, we can find a matrix for each transformation by examining what the transformation does to the standard basis vectors $\vec{i}$ and $\vec{j}$. 
...
\node[inner sep=0pt, anchor=base] (gulls) at (6.25mm,0)
  {\includegraphics[width=100mm]{gulls.jpg}};
  \draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,2);
       \end{tikzpicture}
  \quad\quad
 ...
 \node[inner sep=0pt, anchor=base]  (stretchedgulls) at (6.25mm,0)
  {\includegraphics[width=50mm]{stretchedgulls.jpg}};
\draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,2);
    \end{tikzpicture}
    \end{center}
...
%\begin{image}[4in]
  \begin{center} 
		\begin{tikzpicture}[scale=4]
\node[inner sep=0pt, anchor=base] (gulls) at (6.25mm,0)
  {\includegraphics[width=50mm]{gull.jpg}};
  \draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,2);
       \end{tikzpicture}
  \quad\quad
\begin{tikzpicture}[scale=4]
 \node[inner sep=0pt, anchor=base]  (stretchedgulls) at (6.25mm,0)
  {\includegraphics[width=50mm]{shearedgull.jpg}};
...
It turns out that rotations about the origin are also matrix transformations.  You will have an opportunity to revisit and prove this claim in Problem \ref{prob:linOfRotRef} of \href{https://ximera.osu.edu/linearalgebradzv3/LinearAlgebraInteractiveIntro/SUPX-0060/main}{Additional Exercises}.
...
\node[inner sep=0pt] (tower) at (0,0)
  {\includegraphics[width=90mm]{tower.jpg}};
  \draw[<->] (-2,0)--(2,0);
  \draw[<->] (0,-2)--(0,2);
       \end{tikzpicture}\quad
\begin{tikzpicture}[scale=2.6]
\node[inner sep=0pt] (tower) at (0,0)
  {\includegraphics[width=100mm]{rotatedtower.jpg}};
  \draw[<->] (-2,0)--(2,0);
  \draw[<->] (0,-2)--(0,2);
       \end{tikzpicture}
%\end{image}
...
When a point is reflected about a line, its image is located on the opposite side of the line and the same distance away from the line as the original point.  This is another example of a matrix transformation.  (We will prove that this is a matrix transformation in Problem \ref{prob:linOfRotRef} of \href{https://ximera.osu.edu/linearalgebradzv3/LinearAlgebraInteractiveIntro/SUPX-0060/main}{Additional Exercises}.)
...
\begin{center}
		\begin{tikzpicture}[scale=4]
\node[inner sep=0pt, anchor=base] (gulls) at (6.25mm,0)
  {\includegraphics[width=50mm]{duck.jpg}};
  \draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,1.5);
...
\begin{tikzpicture}[scale=4]
 \node[inner sep=0pt, anchor=base]  (stretchedgulls) at (6.875mm,-4.2mm)
  {\includegraphics[width=55mm]{reflectedduck.jpg}};
  \node[red] at (1.5, 1.3)   (a) {$y=\frac{3}{5}x$};
\draw[red,thick] (0,0)--(2,1.2);
\draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,1.5);
...
\node[inner sep=0pt, anchor=base] (gulls) at (8.75mm,0)
  {\includegraphics[width=70mm]{sheep.jpg}};
  \draw[<->] (-0.25,0)--(2,0);
  \draw[<->] (0,-0.25)--(0,1.8);
       \end{tikzpicture}
  \quad
\begin{tikzpicture}[scale=4]
 ...
 \node[inner sep=0pt, anchor=base]  (stretchedgulls) at (12.35mm,0)
  {\includegraphics[width=98.8mm]{shearedsheep.jpg}};
...
\begin{center}
		\begin{tikzpicture}[scale=4]
\node[inner sep=0pt, anchor=base] (gulls) at (6.25mm,0)
  {\includegraphics[width=50mm]{chipmunk.jpg}};
  \draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-0.5)--(0,2);
...
\node[inner sep=0pt, anchor=base] (gulls) at (6.25mm,-8.9mm)
  {\includegraphics[width=50mm]{upsidedownduck.jpg}};
  \draw[<->] (-0.5,0)--(2,0);
  \draw[<->] (0,-1.5)--(0,1.5);
  \draw[red,thick] (0,0)--(2,1.2);
  \node[red] at (1.5, 1.3)   (a) {$y=\frac{3}{5}x$};
...
\begin{tikzpicture}[scale=4]
 \node[inner sep=0pt, anchor=base]  (stretchedgulls) at (6.875mm,-4.2mm)
  {\includegraphics[width=110mm]{reflectedduck.jpg}};
