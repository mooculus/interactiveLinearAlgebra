...
\begin{image}
    \includegraphics[height=3in]{gulls_pic.jpg}
\end{image}
% \begin{center}
...
\begin{image}
    \includegraphics[height=3in]{gull_pic.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{tower_pic.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{duckEx_pic.jpg}
\end{image}
...
Use the GeoGebra interactive below to decompose a matrix into a product of two matrices corresponding to the basic transformations we discussed above: scalings, rotations, shears and reflections.
...
Let  $M=\begin{bmatrix}-1&0\\0&-1\end{bmatrix}$.  Use the GeoGebra interactive above to visually examine the transformation induced by $M$.  What sequence of transformations is equivalent to the transformation induced by $M$? 
...
What sequence of transformations is equivalent to the transformation induced by $M$? 
\begin{multipleChoice}  
...
\begin{image}
    \includegraphics[height=3in]{gull_pic1.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{chipmunk_pic.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{duck_pic1.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{duck_pic2.jpg}
\end{image}
...
\begin{image}
    \includegraphics[height=3in]{duck_pic3.jpg}
\end{image}
