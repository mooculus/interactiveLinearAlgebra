...
% We determined this answer was not correct, so updated below
% This answer appears to be correct for the next problem.
% The answer was added to the next problem.
%${\bf p}=\begin{bmatrix}
%\answer{t} \\
%\answer{3t} \\
%\answer{t}
...
% This was commented out due to an Errata submission through the website.
% ${\bf p}=\begin{bmatrix}
% \answer{4t} \\
% \answer{3t} \\
% \answer{2t}
...
% This answer is for part (b) of the first problem from Nicholson.  This problem matches part (b).
${\bf p}=\begin{bmatrix}
\answer{t} \\
\answer{3t} \\
\answer{t}
