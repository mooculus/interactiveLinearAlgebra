...
A matrix is called a \dfn{square matrix} if it has the same number of rows and columns.
If $B=\begin{bmatrix}b_{ij}\end{bmatrix}$ is an $n \times n$ square matrix, the entries of the form $b_{ii}$ are said to lie on the \dfn{main diagonal}.  For example, if $$B=\begin{bmatrix}1&2&3\\4&5&6\\7&4&9\end{bmatrix}$$
