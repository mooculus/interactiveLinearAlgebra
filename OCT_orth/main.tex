...
\begin{example}\label{ex:LeastSquaresComp1}
  We will compare the results of two implementations of least squares for a $7\times 3$ coefficient matrix.
  ...
  \href{https://sagecell.sagemath.org/?z=eJyNTsGKwjAQvQfyD-8i6ELAtC6rlB4KXvwGdw-JO2uDbVKTVMSvN8Equ7edNwzzmDfzZoYt_RhL6FX05oqGs6bebyBKlBVnSCEhJOREVli-eplR4UE2WVVME1FgjY9fMvH-NbEcnM2ethc6ROehOdP1vqxkQlGtUhVl3sjKXT901JON6EiFiHAelaeAMRh7hBs9nDdHY1WHnmLrvjm7ydrYyzx6ZcPgAs2bxVvKP1z_53psCVodTqFToYUbyKv0bjIo6uZT3wFXCVT6&lang=octave&interacts=eJyLjgUAARUAuQ==}{Link to code}.   
  
  \end{example}
  

\begin{example}\label{ex:LeastSquaresComp2}
We will compare the performance of two implementations of least squares for a $2000\times 20$ coefficient matrix.
