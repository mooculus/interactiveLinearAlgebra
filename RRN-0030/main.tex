...
You are probably familiar with the expression ``two points determine a line."  This means that given two distinct points, there is exactly one line that passes through both of them.  There are other ways to describe a line.  For example, as we saw in \href{https://ximera.osu.edu/linearalgebradzv3/LinearAlgebraInteractiveIntro/RRN-0020/main}{Parametric Equations of Lines}, a single point together with a direction vector also determine a line. 
...
\begin{problem}\label{prob:eqplane1}  Find an equation of the form $ax+by+cz=d$ for the plane described below.
  ...
  \begin{problem}\label{prob:eqplane2} Find an equation of the form $ax+by+cz=d$ for the plane described below.
  ...
  \begin{problem}\label{prob:eqplane3} Find an equation of the form $ax+by+cz=d$ for the plane described below.
...
\begin{problem}\label{prob:eqplane4} How many planes satisfying the given conditions are there?
...
\begin{problem}\label{prob:eqplane5} How many planes satisfying the given conditions are there?
...
\begin{problem}\label{prob:eqplane6} How many planes satisfying the given conditions are there?
