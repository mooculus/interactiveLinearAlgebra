...
\chapterstyle    % Default style   (202606: needed for only section-numbering ....)
...
\colorlet{penColor1}{violet} % Color of a curve in a plot
\colorlet{penColor2}{green!55!cyan!40!black}% Color of a curve in a plot
