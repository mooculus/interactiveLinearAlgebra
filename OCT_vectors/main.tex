...
\begin{remark}
    \begin{itemize}
        \item In Octave, we use $\%$ to annotate our code with comments.  Octave does not execute anything that appears on a line after $\%$. It is always a good idea to make notes about your code for yourself and others. 
