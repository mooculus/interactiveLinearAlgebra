...
The representation of points and vectors is driven by the established coordinate system.
...
\begin{idea}
   ...
   \begin{itemize}
\item Every point can be represented using the coordinate system;
\item Each point has a unique representation.
\end{itemize}
\end{idea}
