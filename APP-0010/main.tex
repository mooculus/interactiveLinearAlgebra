...
\fill (-2, 2)node[above,scale=1.5]{$A$} circle (0.5mm);
\fill (2, 2)node[above, scale=1.5]{$B$} circle (0.5mm);
\fill (0, -2)node[left, scale=1.5]{$C$} circle (0.5mm);
\fill (0,0)node[above, scale=1.5]{$D$} circle (0.5mm);
\node[scale=1.5] at (0, 2.4)   (a) {$f_1$};
\node[scale=1.5] at (-2.8, 2.3)   (a) {$500$};
\node[scale=1.5] at (2.8, 2.3)   (a) {$400$};
\node[scale=1.5] at (-0.6, 1)   (a) {$f_2$};
\node[scale=1.5] at (0.6, 1)   (a) {$f_4$};
\node[scale=1.5] at (-1.4, 0)   (a) {$f_3$};
\node[scale=1.5] at (1.4, 0)   (a) {$f_6$};
\node[scale=1.5] at (0.3, -0.6)   (a) {$f_5$};
\node[scale=1.5] at (0.3, -2.5)   (a) {$100$};
\end{tikzpicture}
\end{image}
...
\fill (0,-2)circle (0.5mm);
\node[scale=1.5] at (0.3, 2.4)   (a) {$50$};
\node[scale=1.5] at (-2.8, 0.3)   (a) {$40$};
\node[scale=1.5] at (2.8, 0.3)   (a) {$60$};
\node[scale=1.5] at (-1.2, 1.2)   (a) {$f_1$};
\node[scale=1.5] at (1.2, 1.2)   (a) {$f_2$};
\node[scale=1.5] at (0, 0.3)   (a) {$f_3$};
\node[scale=1.5] at (-1.2, -1.2)   (a) {$f_4$};
\node[scale=1.5] at (1.2, -1.2)   (a) {$f_5$};
\node[scale=1.5] at (0.3, -2.4)   (a) {$50$};
\end{tikzpicture}
\end{image}
...
\fill (0,4)circle (0.5mm);
\node[scale=1.5] at (-5, 0.3)   (a) {$50$};
\node[scale=1.5] at (4.8, 0.3)   (a) {$60$};
\node[scale=1.5] at (0.3, 4.5)   (a) {$25$};
\node[scale=1.5] at (0.3, -4.5)   (a) {$40$};
\node[scale=1.5] at (0.3, 0.8)   (a) {$75$};
\node[scale=1.5] at (-2, 2.5)   (a) {$f_1$};
\node[scale=1.5] at (2.2, 2.5)   (a) {$f_2$};
\node[scale=1.5] at (-2, -0.5)   (a) {$f_3$};
\node[scale=1.5] at (2, -0.5)   (a) {$f_4$};
\node[scale=1.5] at (-2, -2.5)   (a) {$f_5$};
\node[scale=1.5] at (2, -2.5)   (a) {$f_7$};
\node[scale=1.5] at (0.3, -2.8)   (a) {$f_6$};
\end{tikzpicture}
\end{image}
...
\fill (-2, 0)node[above left]{$A$} circle (0.5mm);
\fill (0, 2)node[above right]{$B$} circle (0.5mm);
\fill (2,1)node[above right]{$C$} circle (0.5mm);
\fill (2, -2)node[right]{$D$} circle (0.5mm);
\node[scale=1.5] at (-3, 0.3)   (a) {$55$};
\node[scale=1.5] at (-0.3, 2.4)   (a) {$20$};
\node[scale=1.5] at (1.7, -2.4)   (a) {$20$};
\node[scale=1.5] at (2.5, 0.7)   (a) {$15$};
\node[scale=1.5] at (-1,1.5)   (a) {$f_1$};
\node[scale=1.5] at (0.5, 0.2)   (a) {$f_2$};
\node[scale=1.5] at (1.2, 1.8)   (a) {$f_3$};
\node[scale=1.5] at (0, -1.4)   (a) {$f_4$};
\node[scale=1.5] at (2.3, -0.5)   (a) {$f_5$};
\end{tikzpicture}
\end{image}
...
\fill (-2, 0)node[above left]{$A$} circle (0.5mm);
\fill (-1,-1)node[below left]{$B$} circle (0.5mm);
\fill (2, -1)node[below left]{$C$} circle (0.5mm);
\fill (2, 1)node[above right]{$D$} circle (0.5mm);
\fill (0, 2)node[above right]{$E$} circle (0.5mm);
\node[scale=1.5] at (-3, 0.3)   (a) {$50$};
\node[scale=1.5] at (-0.3, 2.4)   (a) {$35$};
\node[scale=1.5] at (1.7, -2.4)   (a) {$20$};
\node[scale=1.5] at (2.8, 0.7)   (a) {$25$};
\node[scale=1.5] at (-0.7, -1.7)   (a) {$30$};
\node[scale=1.5] at (2.8, -1.4)   (a) {$40$};
\node[scale=1.5] at (-1,1.5)   (a) {$f_5$};
\node[scale=1.5] at (2.3, 0)   (a) {$f_3$};
\node[scale=1.5] at (1.2, 1.8)   (a) {$f_4$};
\node[scale=1.5] at (0.5, -1.3)   (a) {$f_2$};
\node[scale=1.5] at (-1.7, -0.7)   (a) {$f_1$};
\end{tikzpicture}
\end{image}
