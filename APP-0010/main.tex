...
\fill (-2, 2)node[above,scale=2]{$A$} circle (0.5mm);
\fill (2, 2)node[above, scale=2]{$B$} circle (0.5mm);
\fill (0, -2)node[left, scale=2]{$C$} circle (0.5mm);
\fill (0,0)node[above, scale=2]{$D$} circle (0.5mm);
\node[scale=2] at (0, 2.4)   (a) {$f_1$};
\node[scale=2] at (-2.8, 2.3)   (a) {$500$};
\node[scale=2] at (2.8, 2.3)   (a) {$400$};
\node[scale=2] at (-0.6, 1)   (a) {$f_2$};
\node[scale=2] at (0.6, 1)   (a) {$f_4$};
\node[scale=2] at (-1.4, 0)   (a) {$f_3$};
\node[scale=2] at (1.4, 0)   (a) {$f_6$};
\node[scale=2] at (0.3, -0.6)   (a) {$f_5$};
\node[scale=2] at (0.3, -2.5)   (a) {$100$};
\end{tikzpicture}
\end{center}
