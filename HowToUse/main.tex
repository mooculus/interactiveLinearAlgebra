...
Please refer to the Octave Tutorial section for more information on how to use Octave and Octave Cells.

\subsection*{Keeping Track of Progress}
XIMERA does not require a log-in.  Your answers will be saved automatically, and XIMERA will remember your progress.  WARNING: You will lose your work if you clear out your cookies.  You will also lose your work if you switch to a different computer.
