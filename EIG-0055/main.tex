...
\begin{problem}\label{prob:ex:diagonalizematrix}
    Fill in the details" of Example \ref{ex:diagonalizematrix}.
\begin{question}\label{prob:ex:diagonalizematrix1}
...
\begin{question}\label{prob:ex:diagonalizematrix2}
Find a basis for each eigenspace of the matrix $A$.
\end{question}

\begin{question}\label{prob:ex:diagonalizematrix3}
...
\begin{question}\label{prob:ex:diagonalizematrix5}
Compute $D=P^{-1}AP$
\end{question}

\begin{question}\label{prob:ex:diagonalizematrix4}
...
\begin{problem}\label{prob:diagProb1}
Let $A=\begin{bmatrix}4 & -1\\-3 & 2\end{bmatrix}$
\begin{question}
    Find the eigenvalues of $A$ and list them in increasing order.
    $$\lambda_1=\answer{1},\quad\lambda_2=\answer{5}$$
\end{question}
\begin{question}
    Find a diagonalization for $A$
    $$\begin{bmatrix}\lambda_1 & 0\\0 & \lambda_2\end{bmatrix}=P^{-1}AP=\frac{1}{4}\begin{bmatrix}1 & \answer{1}\\\answer{-3} & 1\end{bmatrix}\begin{bmatrix}4 & -1\\-3 & 2\end{bmatrix}\begin{bmatrix}1 &\answer{-1}\\\answer{3} & 1\end{bmatrix}$$
\end{question}
...
\begin{question}
    ...
    $$\lambda_1=\answer{1},\quad\lambda_2=\answer{1},\quad\lambda_3=\answer{2}$$
\end{question}

\begin{question}
    Find a diagonalization for $A$.
    $$\begin{bmatrix}\lambda_1 & 0 & 0\\0 & \lambda_2 & 0\\0 & 0 & \lambda_3\end{bmatrix}=P^{-1}AP=\begin{bmatrix}\answer{-1} & \answer{0} &\answer{-1}\\0&0&1\\\answer{1} & \answer{1}&\answer{1}\end{bmatrix}\begin{bmatrix}
1 & 0 & 0 \\
1 & 2 & 1 \\
0 & 0 & 1
\end{bmatrix}\begin{bmatrix}\answer{-1} & \answer{-1} & \answer{0}\\1 & \answer{0} & 1\\\answer{0} &1 & \answer{0}\end{bmatrix}$$
\end{question}
\end{problem}

\begin{problem}\label{prob:notDiagonalizable3by3}
    Let $$A=\begin{bmatrix}
4 & 0 & 0 \\
0 & 2 & 2 \\
2 & 3 & 1
\end{bmatrix}$$
    ...
    $\lambda_1=4$ is an eigenvalue of algebraic multiplicity $\answer{2}$.

    $$\mathcal{S}_{\lambda_1}=\text{span}\left(\begin{bmatrix}\answer{0}\\\answer{1}\\1\end{bmatrix}\right)$$

    Geometric multiplicity of $\lambda_1$ is $\answer{1}$.
