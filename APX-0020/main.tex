...
The complex numbers, denoted $\mathbb{C}$, have the wonderful property that \textit{every} polynomial with complex coefficients has a (complex) root. This fact is known as the \dfn{Fundamental Theorem of Algebra}.
...
\begin{enumerate}
    \item Plot $z$, $w$, and $z+w$ in the on the same plane to see an example of the \dfn{parallelogram law} of complex addition.
...
\begin{theorem}[Fundamental Theorem of Algebra]\label{th:034196}
