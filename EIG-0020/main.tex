...
\begin{remark}
    Recall that $\lambda_1=1$ has algebraic multiplicity $2$.  Note that $\text{dim}(\mathcal{S}_{\lambda_1})=2$.  We say that  $\lambda_1$ has geometric multiplicity $2$.  We have to be careful, and not draw hasty conclusions. Geometric and algebraic multiplicity are NOT always the same!  We will revisit this issue later in the text.
\end{remark}
