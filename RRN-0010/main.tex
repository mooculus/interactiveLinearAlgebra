...
\begin{tikzpicture}[scale=1.5]
 ...
 \fill (1,1)node[below right]{$A(x_1,y_1)$} circle (0.5mm);
\fill (4, 2.5)node[above]{$B(x_2,y_2)$} circle (0.5mm);
\draw[line width=0.5pt, dashed](1,1)--(1,0);
   \draw[line width=0.5pt, dashed](1,1)--(0,1);
   \draw[line width=0.5pt, dashed](4,2.5)--(4,0);
   \draw[line width=0.5pt, dashed](4, 2.5)--(0,2.5);
